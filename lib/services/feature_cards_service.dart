...
class FeatureCardsService {
  ...
  static List<FeatureCard> get defaultCards => [
    FeatureCard(
      ...
      subtitle: 'Matematik, Fizik, Kimya, Biyoloji - her türlü sorunun fotoğrafını çek! Yapay zeka anında adım adım çözüm sunar. Formüller ve işlem basamakları açıkça gösterilir. (10 💎)',
    ...
    FeatureCard(
      ...
      subtitle: 'Cevabı direkt vermez, seni doğru cevaba yönlendiren sorular sorar. Gerçek öğretmen gibi düşünmeyi öğretir. Böylece konuyu gerçekten anlarsın! (5 💎)',
